...
export const UserResponseMessages = {
  ...
  FIRST_ADMIN_CREATED: "First admin user created successfully",
  ...
  USER_ALREADY_EXISTS_LOGIN_INSTEAD: "At least 1 user already exists in the system. Please use those credentials to log in",
